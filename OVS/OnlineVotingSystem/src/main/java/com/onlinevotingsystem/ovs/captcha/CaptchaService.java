...
import com.onlinevotingsystem.ovs.validation.ReCaptchaUnavailableException;
...
public class CaptchaService implements ICaptchaService {
    ...
    public void processResponse(final String response) {
        ...
        try {
            ...
            throw new ReCaptchaUnavailableException("Service unavailable at this time.  Please try again later.", rce);
        }
